...
int main (int argc, char **argv)
{
  ...
  {    
    ...
    int tsid0 = mfControl.insertVertex (&tsSearch);
    int said1 = mfControl.insertVertex (&saSearch);  
    int said2 = mfControl.insertVertex (&saSearch);  
    int said3 = mfControl.insertVertex (&saSearch);  
    int hcid4 = mfControl.insertVertex (&hcSearch, bslect);
    
    mfControl.insertEdge(tsid0, said1);
    mfControl.insertEdge(tsid0, said2);
    mfControl.insertEdge(tsid0, said3);
    mfControl.insertEdge(said1, hcid4);
    mfControl.insertEdge(said2, hcid4);
    mfControl.insertEdge(said3, hcid4);
    mfControl.insertLoop(hcid4, tsid0, nloop);
